...
interface ISimulator
{
    ...
    /// <param name="maxFrames"> The maximum number of frames to simulate. </param>
    ...
    Task<int> Simulate(Scene scene, CancellationToken ct, int maxFrames = int.MaxValue, string? simulationFilename = null);
}
